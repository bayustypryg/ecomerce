<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
	<div class="container">
		<a class="navbar-brand" href="<?= base_url() ?>">
			<img src="<?= base_url('images/logo/logo.png') ?>" width="40" alt="">
		Tiara Brand</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav mr-auto">
				...
				<?php if($this->session->userdata('role') == 'admin') : ?>
					<li class="nav-item dropdown">
						<a href="#" class="nav-link dropdown-toggle" id="dropown-1" data-toggle="dropdown"
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a href="<?= base_url('cart') ?>" class="nav-link text-light"><i class="fas fa-shopping-cart">Cart(<?= getCart() ?>)</i></a>
				</li>
				...
				<?php else: ?>
					<li class="nav-item dropdown">
						<a href="#" class="nav-link dropdown-toggle text-light" id="dropown-2" data-toggle="dropdown"
