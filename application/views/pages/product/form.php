                        ...
                        <div class="card-body">
                            ...
                            <?= isset($input->id) ? form_hidden('id', $input->id) : '' ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_input(['type' => 'number', 'name' => 'price', 'min' => '0', 'value' => $input->price, 'class' => 'form-control', 'required' => true]) ?>
                                    <?= form_error('price'); ?>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_input(['type' => 'number', 'name' => 'stock', 'min' => '0', 'value' => $input->stock, 'class' => 'form-control', 'required' => true]) ?>
                                    <?= form_error('stock'); ?>
                                </div>
                                <div class="form-group">
